...
Beta Bertahap Dibuka — Kuota 500 Seller
          </span>
        </div>
        ...
        <div className="flex flex-col gap-4 text-left">
          <h1 className="text-4xl md:text-5xl xl:text-6xl font-bold leading-[1.1] tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white via-purple-200 to-purple-400">
            Upload Foto Produk, Jawab Brief Singkat, lalu Dapat Desain Siap Upload
          </h1>
          <h2 className="text-slate-400 text-lg lg:text-xl font-normal leading-relaxed max-w-xl">
            SmartDesign bantu seller UMKM bikin desain promo yang siap dipakai di Shopee, Tokopedia, Instagram, dan WhatsApp.
            <strong className="text-white"> Akses beta dibuka bertahap</strong> — saat diundang dan aktivasi akun, kamu dapat 100 kredit awal.
          </h2>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4">
          <div className="flex flex-col gap-2 w-full sm:w-auto">
            ...
            >
              <span className="whitespace-nowrap">Ajukan Akses Beta — Dapat 100 Kredit Saat Diundang</span>
